Template.teamsIndex.helpers({

});

Template.teamsIndex.events = {
    ...
    /* sorting by parameter */
    'click #btnSortemployeeid': function(e) {
    MeteorisGridView.sort('employeeid');
    },
    /* sorting by parameter */
    'click #btnSortjob': function(e) {
    MeteorisGridView.sort('job');
    },
    /* sorting by parameter */
    'click #btnSorttop': function(e) {
    MeteorisGridView.sort('top');
    },
