NewsFeedController = MeteorisController.extend({
    ...
    subscriptions: function() {
        ...
        this.subs.subscribe('feeds',{});
        this.subs.subscribe('posts',{});
        this.subs.subscribe('projects',{});
        this.subs.subscribe('campaigns',{});
        this.subs.subscribe('suggests',{});
...
{colorStyles: {$regex: search, $options: 'i'}},
...
colorStyles: t.find('#colorStyles').value,
