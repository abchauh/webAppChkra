...
{tags: {$regex: search, $options: 'i'}},
    ...
    insert: function(t) {
        if (this._post) {
            ...
            Projects.insert(doc, function(err, _id) {
                ...
                MeteorisFlash.set('success', "Success Inserting Project");
    ...
    update: function(t) {
        ...
        if (this._post) {
            ...
            Projects.update(_id, {$set: doc}, function(err) {
                ...
                MeteorisFlash.set('success', "Success Updating Project");
            });
            Router.go('projectsView', {_id: _id});
        }
    ...
    remove: function(_id) {
        Projects.remove(_id, function(err) {
            ...
            MeteorisFlash.set('success', "Success Removing Project");
        });
    },
