CampaignsController = MeteorisController.extend({
    ...
    _getDoc: function(t) {
        return {
            ...
            shortdscrption: t.find('#shortdscrption').value,
            longdscrption: t.find('#longdscrption').value,
            story: t.find('#story').value,
        };
    },
    ...
    /* Publish Campaigns by id*/
    publish: function(_id) {
        Campaigns.update({_id: _id}, {$set: {pubstatus: "Published"}});
         MeteorisFlash.set('success', "Campaigns published successfully.");
    },
    finish: function(_id) {
        Campaigns.update({_id: _id}, {$set: {pubstatus: "Finished"}});
        MeteorisFlash.set('success', "Campaigns finished.");
    },
    republish: function(_id) {
        Campaigns.update({_id: _id}, {$set: {pubstatus: "Published"}});
        MeteorisFlash.set('success', "Campaigns republished successfully.");
    }
});