...
CausesUpdates = new Mongo.Collection("causesUpdates");
...
CausesUpdates.attachSchema(schemas);
...
//activate groundDB for causesUpdates collection to work offline
Ground.Collection(CausesUpdates);

CausesUpdates.helpers({
    image: function() {
